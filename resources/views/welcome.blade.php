        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <x-home.home-page title="Documentation AAA" style="color: red;" link="https://laravel.com/docs" class="shadow">
                        <x-slot name="icon">
                            <div
                    ...
                    <x-home.home-page title="Laracasts" style="color: red;" link="https://laracasts.com">
                        <x-slot name="icon">
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <x-home.home-page title="Laravel News" style="color: red;" link="https://laravel-news.com">
                        <x-slot name="icon">
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <x-home.home-page title="Vibrant Ecosystem" style="color: red;">
                        <x-slot name="icon">
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
